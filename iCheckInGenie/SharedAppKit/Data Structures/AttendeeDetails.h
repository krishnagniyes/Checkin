...
@interface AttendeeDetails : NSManagedObject

@property (nonatomic, retain) NSString *Acct_Id;
@property (nonatomic, retain) NSString *Additional_Guests;
...
@property (nonatomic, retain) NSString *Cnfrm_Cd;
...
@property (nonatomic, retain) NSString *Custm_Fld_7Val_Txt;
...
@property (nonatomic, retain) NSString *Fst_Nm;
...
@property (nonatomic, retain) NSString *Phn_Num;
